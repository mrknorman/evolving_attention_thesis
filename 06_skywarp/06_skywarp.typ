...
The models we describe in this section are novel in that they utilize attention mechanisms (Bahdanau et al. 2014,  Luong et al. 2015), a type of differentiable memory in which a global context vector is learned over an input sequence $x_i$. 

Search analogy and diagram
