...
#figure(
    image("hyperparameter_space.png",  width: 80%), 
...
#figure(
    image("grid_search.png",  width: 100%), 
...
#figure(
    image("random_search.png",  width: 80%), 
...
#figure(
    image("bayesian_descent.png",  width: 80%), 
